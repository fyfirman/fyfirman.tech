...
const IndexPage = () => {
  ...
  return (
    <Layout>
      ...
      {/* Weapon section */}
      <h2 className="headings2">My Weapons</h2>
      <div className='weapon-container'>
        <div style={{ flex: 1 }}>
          <h3 className="weaponType">Primary</h3>
        ...
        <div style={{ flex: 1 }}>
          <h3 className="weaponType">Secondary</h3>
          <div>
            <div style={{ display: "flex", justifyContent: "center" }}>
              <Weapon name="Laravel" />
              <Weapon name="Docker" />
      ...
      {/* Project Section */}
      <h2 className="headings2" id="project-section">Selected Project</h2>
      ...
      {/* Contact Section */}
      <h2 className="headings2">Get In Touch With Me</h2>
      <div style={{ maxWidth: '600px' }}>
        <p className="body">I'm very happy to share knowledge. If you want to ask something about IT, productivity, or my college experience, feel free to discuss via <b>Instagram</b>.</p>
        <p className="body">For <b>hiring, business, or collaboration</b> please contact me via <b>email (fyfirman@gmail.com)</b> or <b>Linkedin</b>.</p>
        <Link to="/message" className="contact-button">Send me a message</Link>
      </div>
      <div id="contact-section" className="sosmed-container">
